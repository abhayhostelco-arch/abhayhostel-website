...
import { getEntries, getProfiles, getScoreSettings, getStudentLeaderboardSource } from "@/lib/data";
...
export default async function MentorDashboard() {
  ...
  const [entries, settings, globalSource] = await Promise.all([getEntries({ startDate: start, studentIds: active.map((student) => student.id) }), getScoreSettings(), getStudentLeaderboardSource(start)]);
